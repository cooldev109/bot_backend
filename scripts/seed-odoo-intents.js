...
const odooIntents = [
  ...
  },
  {
    ...
    description: "User wants to create a sales order or purchase products in Odoo",
    examples: [
      ...
      "Purchase a product",
      "I want to purchase a coat",
      "Buy product",
      "I need to buy something",
      "Order a laptop for me",
      "Can I buy a jacket?",
      "I'd like to purchase an office chair",
      "I want to order 2 laptops",
      "Buy now",
      "Purchase this item",
      "I want to buy a coat in odoo",
      "Get me a jacket",
    ],
  },
  {
